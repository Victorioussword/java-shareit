...
public class ItemClient extends BaseClient {
    ...
    public  ResponseEntity<Object> update(ItemDto itemDto, long itemId, Long userIdInHeader) {

        return patch("/" + itemId, userIdInHeader, itemDto);
    }
    ...
    public ResponseEntity<Object> createComment(CommentDtoInput comment, long userId, long itemId) {
